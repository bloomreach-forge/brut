...
public class ImporterUtilsTest {
    ...
    public void setup() throws RepositoryException, IOException {
        ...
        InputStream hippoCnd = getResourceAsStream("org/bloomreach/forge/brut/common/repository/utils/hippo.cnd");
        InputStream hippoStdCnd = getResourceAsStream("org/bloomreach/forge/brut/common/repository/utils/hippostd.cnd");
        InputStream hippogalleryCnd = getResourceAsStream("org/bloomreach/forge/brut/common/repository/utils/hippogallery.cnd");
    ...
    public void testImportingImage() throws Exception {
        URL resource = getClass().getResource("/org/bloomreach/forge/brut/common/repository/utils/gallery.yaml");
