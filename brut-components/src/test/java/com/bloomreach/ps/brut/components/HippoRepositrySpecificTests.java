...
public class HippoRepositrySpecificTests extends BaseComponentTest {
    ...
    public void setupScenario() throws RepositoryException {
        ...
        URL blogResource = getClass().getResource("/com/bloomreach/ps/brut/components/blog.yaml");
        URL blogFacetResource = getClass().getResource("/com/bloomreach/ps/brut/components/blogFacets.yaml");
